...
When we do this work, the GPU we use is rtx3090, so if you wang to run these programs， we suggest you also use rtx3090. ** Note that at least 12GB GPU memeory is required. **
