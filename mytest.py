...
#
# valules = np.linspace(start=-1, stop=1, num=5)
#
...
#     s_array.append(s)
#
# index = random.sample(s_array, 512)
...
#
#     Image.fromarray(image_out_g[0], 'RGB').save('./data/mytest/images' + f'/image_out' + str(i) + '.png')
#     np.savetxt(f'./data/mytest/latentz/latent{i}.txt', inp.numpy())
#     np.savetxt(f'./data/mytest/features/feature{i}.txt', feature_new.numpy())
