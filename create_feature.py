...
from ModelZoo import loadArcfaceModel
...
# lfw_dataset_path = r"D:\data\lfw_select"
# names_list = os.listdir(lfw_dataset_path)
# print(names_list)

# for name in names_list:
#     imgPair_path = os.path.join(r"D:\data\lfw_pairs", f"{name}_pair")
#     imgResult_path = os.path.join(r"D:\data\lfw_select_result", f"{name}")
...
#     os.mkdir(os.path.join(imgPair_path, "pred_img"))
...
lfw_pairs_path = "./data/lfw_pairs"
names_list = os.listdir(lfw_pairs_path)

lfw_feature_path = "./data/lfw_feature_pairs"
